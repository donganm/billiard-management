...
namespace btl
{
    public partial class InHoaDonNV : Page
    {
        ...
        {
            string connectionString = @"Data Source=DESKTOP-AS5T8FU\SQLEXPRESS01;Initial Catalog=QLBia;User Id=sa;Password=Anhthidong04+;Trusted_Connection=true;TrustServerCertificate=True";
